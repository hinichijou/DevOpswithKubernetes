...
[build-deploy-on-push.yaml](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/.github/workflows/build-deploy-on-push.yaml) defines the GitHub workflow.
