...
See the [monitoring folder](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/monitoring) and the [monitoring readme](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/monitoring/README.md) for instructions on how to run a monitoring setup for the deployment.
