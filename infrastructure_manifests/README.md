...
* [gateway.yaml](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/infrastucture_manifests/manifests/gateway.yaml): defines the gateway resource for cluster service access.
* [namespaces.yaml](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/infrastucture_manifests/manifests/namespaces.yaml): defines all of the project namespaces and a rule if the namespace is allowed to attach routes to the gateway.
