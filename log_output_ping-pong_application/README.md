...
With `failureCondition: result > 0.001` the next deployment fails as expected:
```
NAME                                          KIND         STATUS        AGE    INFO
