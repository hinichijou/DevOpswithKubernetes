...
* [route_prometheus.yaml](https://github.com/hinichijou/DevOpswithKubernetes/tree/4.7/services/prometheus/manifests/route_prometheus.yaml): defines the route resource for accessing the Prometheus service. The query interface will be available at `http://localhost:*application-port-here*/prometheus/query`
